        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-100 ">
          <ul className="space-y-2 font-medium">
            <li onClick={() => handleClickItem('Dashboard')}>
              <Link href={"admin#"} className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Dashboard' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Orders')}>
              <Link href="admin#" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Orders' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Sellers')}>
              <Link href="admin#" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Customers' ? 'bg-fuchsia-600 text-white' : ''}`}>
                ...
                <span className="ms-3 font-medium text-lg">Sellers</span>
              </Link>
            </li>
            <li onClick={() => handleClickItem('Products')}>
              <Link href="allProduct" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Products' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Catogery')}>
              <Link href="/category" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Catogery' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Invoice')}>
              <Link href="admin#" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Invoice' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Help')}>
              <Link href="admin#" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Help' ? 'bg-fuchsia-600 text-white' : ''}`}>
            ...
            <li onClick={() => handleClickItem('Settings')}>
              <Link href="admin#" className={`flex items-center px-2 py-3 text-gray-900 rounded-lg hover:bg-fuchsia-600 group ${active === 'Settings' ? 'bg-fuchsia-600 text-white' : ''}`}>
